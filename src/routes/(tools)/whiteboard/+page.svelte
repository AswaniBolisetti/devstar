  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function toggleDropdown(dropdown) {
        ...
        dropdown.parentElement.querySelector('.dropdown-arrow').classList.toggle('active', isActive);
      }
      ...
      document.getElementById('pencil').addEventListener('click', () => activateTool('pencil'));
      document.getElementById('eraser').addEventListener('click', () => {
        activateTool(tool === 'eraser' ? 'pencil' : 'eraser');
        toggleDropdown(document.getElementById('eraser-width-dropdown'));
      });
      ...
      document.getElementById('fill').addEventListener('click', () => {
        activateTool('fill');
        toggleDropdown(document.getElementById('color-palette-dropdown'));
      });
      ...
      document.getElementById('shapes').addEventListener('click', () => {
        activateTool('shapes');
        toggleDropdown(document.getElementById('shapes-dropdown'));
      });
